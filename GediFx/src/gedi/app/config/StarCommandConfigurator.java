...
public class StarCommandConfigurator extends CommandConfigurator {

	
	public StarCommandConfigurator() {
		super("Read mapping","STAR","STAR --version","https://github.com/alexdobin/STAR");
	}

	
	@Override
	public String getHelp() {
		return "For mapping of reads, STAR must be installed and runnable from command line!";
	}
