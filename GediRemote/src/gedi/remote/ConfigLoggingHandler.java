...
public class ConfigLoggingHandler extends ChannelDuplexHandler {
    ...
    private boolean writeHexDump = false;

    
    public ConfigLoggingHandler setWriteHexDump(boolean hex) {
    	writeHexDump = hex;
    	return this;
    }
     ...
     */
    public ConfigLoggingHandler(Class<?> clazz) {
     ...
     */
    public ConfigLoggingHandler(String name) {
    ...
    protected String format(ChannelHandlerContext ctx, String eventName, Object arg) {
        if (arg instanceof ByteBuf) {
            return formatByteBuf(ctx, eventName, (ByteBuf) arg, writeHexDump);
        } else if (arg instanceof ByteBufHolder) {
            return formatByteBufHolder(ctx, eventName, (ByteBufHolder) arg, writeHexDump);
        } else {
     ...
     */
    private static String formatByteBuf(ChannelHandlerContext ctx, String eventName, ByteBuf msg, boolean writeHex) {
        String chStr = ctx.channel().toString();
     ...
     */
    private static String formatByteBufHolder(ChannelHandlerContext ctx, String eventName, ByteBufHolder msg, boolean writeHex) {
        String chStr = ctx.channel().toString();
