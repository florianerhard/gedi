...
//public class PaintLegend2 extends AbstractLegend2<PaintAesthetic> {
//
//	
//	@Override
...
//			ContinuousContinuousScale ccscale = new ContinuousContinuousScale(ctx->GPlotUtils.inferScaling(scaes.getColumn()), scaes.getPreprocess().getMin(), scaes.getPreprocess().getMax(), ctx->DoubleInvertibleTransformer.iscale(ctx.currentFacet.getArea().getMaxY(), ctx.currentFacet.getArea().getMinY()));
//					
